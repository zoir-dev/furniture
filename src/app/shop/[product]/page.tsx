                        ...
                        <div className="flex items-end justify-between">
                            <div className="flex flex-col gap-[16px]">
                                ...
                                <div className="flex gap-[6px]">
                                    <Button variant="text" className="w-[50px] aspect-[5/4] border-[1px] flex items-center justify-center border-second rounded-[10px] cursor-pointer select-none text-[18px] md:text-[16px] smd:text-[14px] text-second md:w-[45px] smd:w-[40px] active:scale-90 duration-500" onClick={() => dispatch(addItem({ ...data[+pathname.slice(6) || 2], img: `https://picsum.photos/24${pathname.slice(6)}`, id: +pathname.slice(6), count: 0 }))} placeholder=''>+</Button>
                                    <Button variant="text" className="w-[50px] aspect-[5/4] flex items-center justify-center border-[1px] border-second rounded-[10px] cursor-pointer select-none text-[18px] md:text-[16px] smd:text-[14px] text-second md:w-[45px] smd:w-[40px] active:scale-90 duration-500" placeholder=''>{baskets.filter((b: any) => b?.id === +pathname.slice(6))[0]?.count || 0}</Button>
                                    <Button variant="text" className="w-[50px] aspect-[5/4] flex items-center justify-center border-[1px] border-second rounded-[10px] cursor-pointer select-none text-[18px] md:text-[16px] smd:text-[14px] text-second md:w-[45px] smd:w-[40px] active:scale-90 duration-500" onClick={() => dispatch(removeItem(baskets.find((b: any) => b?.id === +pathname.slice(6))))} placeholder=''>-</Button>
                                </div>
                            </div>
                            <Link href='/basket'>
